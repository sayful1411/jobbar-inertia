                        ...
                        <div class="mx-auto max-w-2xl text-center">
                            ...
                            <form @submit.prevent="filter" class="mt-10">
                                <div class="relative w-full">
                                    <svg
                                        class="absolute left-4 top-5 hidden text-white sm:block md:left-8 md:top-7"
                                        width="20"
                                        height="20"
                                        viewBox="0 0 20 20"
                                        fill="none"
                ...
                <div class="grid grid-cols-12 lg:gap-12">
                    <div class="col-span-12" id="find-job">
                        ...
                        <div>
                            ...
                            <template v-if="jobs.data.length">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            <img
                                                class="h-16 w-16 rounded-xl bg-gray-700 p-2"
                            ...
                            <template v-else>
                                <h4
                                    class="my-4 text-center text-xl font-semibold text-white/80"
                                >
